...
- **Main process total < 4800 LOC** (gate `check:main-size`), arquivos em `apps/desktop/src/main/` ≤ 300 LOC cada. Orçamento elevado de 2000→3000 em 2026-04-21 (Epic 10b-wiring), de 3000→4500 em 2026-04-22 (Epic 11-features/02-workspaces), e de 4500→4800 em 2026-04-22 (Epic 11-features/03-projects TASK-11-03-06: legacy-import.ts + métodos legacy em projects-service.ts completam o domínio de projects).
...
pnpm check:main-size               # gate main <4500 LOC, ≤300/arquivo
